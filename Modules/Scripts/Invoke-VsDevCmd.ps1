...
$0 = "${env:ProgramFiles(x86)}\Microsoft Visual Studio\2022\Enterprise\Common7\Tools"
if (Test-Path $0)
{
	Push-Location $0
}
...
{
	$0 = "${env:ProgramFiles(x86)}\Microsoft Visual Studio\2022\Professional\Common7\Tools"
	if (Test-Path $0)
	{
		Push-Location $0
	}
